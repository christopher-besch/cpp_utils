...
public:
    ...
    const std::vector<const char*>& get_init_arguments() const
    {
        return m_init_arguments;
    }
    const std::vector<const char*>& get_arguments() const
    {
        return m_arguments;
    }
    int get_max_amount() const
    {
        return m_max_arguments;
    }
